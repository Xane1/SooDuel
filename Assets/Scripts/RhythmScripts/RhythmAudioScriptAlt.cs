...
public class RhythmAudioScriptAlt : MonoBehaviour
{
   ...
   // public float endBeatOffset;
    ...
    private readonly float[] normalAttackTimestamps = { 20f, 35f, 50f, 65f, 80f, };
    ...
    private readonly float[] hardAttackTimestamps = {15f, 30f, 45f, 60f, 75f, 90f, 105f,};
